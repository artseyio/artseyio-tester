...
function App() {
    return (
        <StyledApp>
            ...
            <h1>ARTSEY Tester</h1>
            <p>
                On this site you're able to test the great ARTSEY layout. Without the need of a dedicated keyboard. The tester supports all alpha key combos, space and backspace.<br/>
